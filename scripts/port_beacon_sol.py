#!/usr/bin/env python3
"""Beacon SOL — expose 8081/8001 → stack docker 18180/18100."""
...
UPSTREAM = {
    8081: ("127.0.0.1", 18180),
    8001: ("127.0.0.1", 18100),
}
...
def serve(listen_port: int, upstream_host: str, upstream_port: int) -> None:
    ...
    srv.listen(64)
    print(f"UltiumGrid SOL beacon http://127.0.0.1:{listen_port}", flush=True)
    while True:
        client, _ = srv.accept()
        try:
